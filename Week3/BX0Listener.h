...
public:
  ...
  virtual void enterBool(BX0Parser::BoolContext *ctx) = 0;
  virtual void exitBool(BX0Parser::BoolContext *ctx) = 0;
  ...
  virtual void enterIfelsecont(BX0Parser::IfelsecontContext *ctx) = 0;
  virtual void exitIfelsecont(BX0Parser::IfelsecontContext *ctx) = 0;
  ...
  virtual void enterBoolop(BX0Parser::BoolopContext *ctx) = 0;
  virtual void exitBoolop(BX0Parser::BoolopContext *ctx) = 0;
  ...
  virtual void enterComparaison(BX0Parser::ComparaisonContext *ctx) = 0;
  virtual void exitComparaison(BX0Parser::ComparaisonContext *ctx) = 0;
