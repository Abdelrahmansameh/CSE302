...
class  BX0Parser : public antlr4::Parser {
public:
  enum {
    ...
    T__32 = 33, T__33 = 34, T__34 = 35, BOOL = 36, VAR = 37, NUM = 38, COMMENT = 39, 
    WS = 40
  };

  enum {
    RuleProgram = 0, RuleVardecl = 1, RuleType = 2, RuleVarinit = 3, RuleStatement = 4, 
    RuleMove = 5, RulePrint = 6, RuleBlock = 7, RuleIfelse = 8, RuleIfelsecont = 9, 
    RuleWhilee = 10, RuleExpr = 11
  };

  BX0Parser(antlr4::TokenStream *input);
  ~BX0Parser();
  ...
  class  BoolContext : public TypeContext {
  public:
    BoolContext(TypeContext *ctx);
  ...
  class  IfelsecontContext : public antlr4::ParserRuleContext {
  public:
    IfelsecontContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    IfelseContext *ifelse();
    BlockContext *block();
  ...
  class  WhileeContext : public antlr4::ParserRuleContext {
  public:
    WhileeContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    ExprContext *expr();
    BlockContext *block();
  ...
  class  UnopContext : public ExprContext {
  public:
    UnopContext(ExprContext *ctx);
